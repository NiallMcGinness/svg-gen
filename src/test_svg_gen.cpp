...
string createFilepath( string id_string){
    ...
    string filePath = "output/test/svg/" + id_string;
    return filePath;
}
...
void genCircle( string id_string ){
    ...
    string svg_header ("<svg width='256' height='256' viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'> <rect width='100%' height='100%' fill='white'/>");
    string circle_template ("<circle cx='<x>' cy='<y>' r='32' fill='white' stroke='black' stroke-width='3' />");
...
string randomise_star(string input_string){
    ...
    vector <vector<int>> base_vector = { {159,55}, {174,85}, {208,90}, {183,112}, {189,144}, {159,129}, {128,144} ,{134,112}, {110,89},  {143,85}};
